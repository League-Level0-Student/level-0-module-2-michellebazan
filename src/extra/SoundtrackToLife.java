...
System.out.println(""+ userMood);
		...
		if(userMood == 0) {
			playVideo("https://www.youtube.com/watch?v=nFinIXw5j_0");
		}
		if(userMood == 1) {
			playVideo("https://www.youtube.com/watch?v=qYS0EeaAUMw");
		}
		if(userMood == 2) {
			playVideo("https://www.youtube.com/watch?v=6SdIVPs8gZ8");
		}
